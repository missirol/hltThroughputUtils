...
hltConfigFromDB --configName /users/missirol/test/dev/CMSSW_15_0_0/tmp/250410_TestDisableEG11AndVBF/Test01/GRun/V1 > tmp_baseline.py

https_proxy=http://cmsproxy.cms:3128/ \
hltConfigFromDB --configName /users/missirol/test/dev/CMSSW_15_0_0/tmp/250410_TestDisableEG11AndVBF/Test01/GRun/V2 > tmp_removeDoubleEleMass6.py

https_proxy=http://cmsproxy.cms:3128/ \
hltConfigFromDB --configName /users/missirol/test/dev/CMSSW_15_0_0/tmp/250410_TestDisableEG11AndVBF/Test01/GRun/V3 > tmp_removeDoubleEleMass6AndParkingVBF.py

cp /gpu_data/store/data/Run2024*/EphemeralHLTPhysics/FED/run"${runNumber}"_cff.py .

for jobSubLabel in baseline removeDoubleEleMass6 removeDoubleEleMass6AndParkingVBF; do
