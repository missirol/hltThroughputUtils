...
hltConfigFromDB --configName /users/missirol/test/dev/CMSSW_15_0_0/tmp/250411_TestLowPtDoubleEG/Test02/GRun/V1 > tmp_baseline.py
...
https_proxy=http://cmsproxy.cms:3128/ \
hltConfigFromDB --configName /users/missirol/test/dev/CMSSW_15_0_0/tmp/250411_TestLowPtDoubleEG/Test02/GRun/V4 > tmp_testLowPtDoublePhoOnly.py
