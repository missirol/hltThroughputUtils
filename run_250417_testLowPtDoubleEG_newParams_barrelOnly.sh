...
hltConfigFromDB --configName /users/missirol/test/dev/CMSSW_15_0_0/tmp/250411_TestLowPtDoubleEG/Test09/GRun/V1 > tmp_baseline.py

https_proxy=http://cmsproxy.cms:3128/ \
hltConfigFromDB --configName /users/missirol/test/dev/CMSSW_15_0_0/tmp/250411_TestLowPtDoubleEG/Test09/GRun/V2 > tmp_testLowPtDoubleEG.py

https_proxy=http://cmsproxy.cms:3128/ \
hltConfigFromDB --configName /users/missirol/test/dev/CMSSW_15_0_0/tmp/250411_TestLowPtDoubleEG/Test09/GRun/V3 > tmp_testLowPtDoubleEleOnly.py

https_proxy=http://cmsproxy.cms:3128/ \
hltConfigFromDB --configName /users/missirol/test/dev/CMSSW_15_0_0/tmp/250411_TestLowPtDoubleEG/Test09/GRun/V4 > tmp_testLowPtDoublePhoOnly.py

cp /gpu_data/store/data/Run2024*/EphemeralHLTPhysics/FED/run"${runNumber}"_cff.py .

for jobSubLabel in baseline testLowPtDoubleEG testLowPtDoubleEleOnly testLowPtDoublePhoOnly; do
...
process = customizeHLTforTestLowPtDoubleEG_newParams_barrelOnly(process)
@EOF
