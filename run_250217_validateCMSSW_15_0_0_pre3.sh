...
hltConfigFromDB --configName /dev/CMSSW_14_2_0/GRun/V14 > tmp0.py

cp /gpu_data/store/data/Run2024*/EphemeralHLTPhysics/FED/run"${runNumber}"_cff.py .

for jobSubLabel in baseline0; do # baseline1 baseline1_PixelCAwp1_MkFit16 baseline1_PixelCAwp2_MkFit16; do
