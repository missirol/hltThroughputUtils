...
hltConfigFromDB --configName /dev/CMSSW_15_0_0/GRun/V60 > tmp_baseline.py

rm -rf tmp_hltFindDuplicates_output
hltFindDuplicates tmp_baseline.py -o tmp_hltFindDuplicates_output
./applyDuplicatesRemoval.py tmp_hltFindDuplicates_output/groups.txt tmp_hltFindDuplicates_output/config.py tmp_target.py
