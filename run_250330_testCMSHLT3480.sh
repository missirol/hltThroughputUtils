...
hltConfigFromDB --configName /users/missirol/test/dev/CMSSW_15_0_0/CMSHLT_3480/Test01/GRun/V1 > tmp_baseline.py

https_proxy=http://cmsproxy.cms:3128/ \
hltConfigFromDB --configName /users/missirol/test/dev/CMSSW_15_0_0/CMSHLT_3480/Test01/GRun/V2 > tmp_target.py
...
process = customizeHLTforCMSHLT3480(process)
@EOF
