...
hltConfigFromDB --configName /dev/CMSSW_15_0_0/GRun/V48 > tmp0.py

cp /gpu_data/store/data/Run2024*/EphemeralHLTPhysics/FED/run"${runNumber}"_cff.py .

for jobSubLabel in baseline FullDoubletRecovery PixelCAwp1 PixelCAwp1_MkFit16 PixelCAwp1_MkFit16_FullDoubletRecovery; do
...
process = customizeHLTforCMSHLT3459_for2025_${jobSubLabel}(process)
@EOF
