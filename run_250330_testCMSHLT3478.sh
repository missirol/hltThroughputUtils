...
hltConfigFromDB --configName /users/missirol/test/dev/CMSSW_15_0_0/CMSHLT_3478/Test02/GRun/V2 > tmp0.py
...
process = customizeHLTforCMSHLT3478_${jobSubLabel}(process)
@EOF
