...
hltConfigFromDB --configName --adg /cdaq/physics/Run2024HI/v1.0.2/HLT/V2 > tmp0.py

cp /gpu_data/store/hidata/HIRun2024*/HIEphemeralHLTPhysics/FED/v1/run"${runNumber}"_cff.py .
...
process = customizeHLTforCMSHLT3387_hidata2024_${jobSubLabel}(process)
@EOF
